...
@section('meta_title', $software->meta_title ?? 'Software Details')
@section('meta_description', $software->meta_description ?? 'Software Details')
...
<div class="container ">
    ...
    <div class="flex flex-col mx-auto items-center justify-center mt-20">
        <div class="w-8/12 ">
            <img class="rounded-lg m-auto w-full h-auto object-cover"
                src="{{ asset('storage/softwares/' . $software->image) }}" alt="{{ $software->name }}">
        </div>
    </div>
    ...
    <div class="my-20" x-data="{ activeTab: 0 }">
        <h2 class="heading-text-regular-medium text-center text-secondary-900 mb-8">{{
            $softwareDetailSettings['key_features_title'] ?? '' }}</h2>
    ...
    <div class="my-20">
        <h2 class="heading-text-regular-medium text-center text-secondary-900 mb-8">{{
            $softwareDetailSettings['technologies_title'] ?? '' }}</h2>
    ...
    <div class="my-20" x-data="{ activeTab: 0 }">
        <h2 class="heading-text-regular-medium text-center text-secondary-900 mb-8">{{
            $softwareDetailSettings['software_plans_title'] ?? '' }}</h2>
        <div class="flex justify-center mb-8">
    ...
    <div class="mt-10 md:mt-16 mb-10 md:mb-20 max-w-[95%] md:max-w-3xl lg:max-w-5xl mx-auto px-4" x-data="{ open: 1 }">
        ...
        <x-frontend.faq-accordion :faqs="$software->faqs" />
    </div>
    {{-- FaQ --}}
</div>
@endsection