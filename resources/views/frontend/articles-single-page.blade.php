...
@section('content')
    ...
    <div class="container ">
        ...
        <h2 class="w-full lg:w-8/12 heading-text-regular-large  text-secondary-950 mt-20">{{ $article_data->title }}</h2>
        ...
        <div class="slider-container mt-20 xl:mb-20 overflow-hidden">
            <div>
                ...
                <div class="flex justify-between my-8 gap-5">
                    <p class="body-text-regular-medium text-secondary-800"> Stay informed with our expert insights! Explore articles on the latest trends, tips, and strategies in web design, digital marketing, and more. </p>
            ...
            <div class="articles-container flex gap-10">
                @foreach ($articles as $article_data)
                    <div class="article-item w-1/3">
                        ...
                        <a href="{{ route('articles_single_page', $article_data->slug) }}" class="inline-block px-3 py-2 rounded-sm border border-secondary-800 label-text-bold-small text-secondary-800 mt-4"> Read more </a>
                    </div>
                @endforeach
            </div>
        </div>
