<footer>
    <div class="container relative">
        <div class="border-b-1 border-secondary-400">
            <div class="py-[60px] flex flex-col lg:flex-row gap-10 lg:gap-[128px] ">
                ...
                <div class="flex flex-col gap-5 w-full lg:w-4/12">
                    ...
                    <div>
                        ...
                        <div class="pt-2 grid grid-cols-2 gap-x-4  lg:gap-x-6 gap-y-4">
                ...
                <div class="w-full lg:w-8/12 flex flex-col sm:flex-row lg:flex-row gap-5">
                    <div class="flex-1">
        ...
        <a href="#"
            class="group absolute top-[60px] right-5 md:-right-16 w-10 md:w-14 h-10 md:h-14 rounded-lg flex justify-center items-center border border-secondary-600 hover:border-transparent hover:bg-primary-600 transition-all duration-500 ease-in-out text-secondary-800 hover:text-white drop-shadow-xl">
