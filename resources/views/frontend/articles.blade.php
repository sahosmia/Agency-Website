   ...
   <div class="container mx-auto">
    <h1 class="text-[52px] font-medium leading-[68px] text-center mt-5">
      ...
      <div class="flex justify-center gap-6 mt-14">
        <div
          class="flex w-[496px] items-center p-4 gap-4 border border-[#82848E] rounded-lg place-content-between"
        >
          <p class="text-[22px] font-normal leading-7 w-auto mr-5">
            Search by any niche
          </p>
          <button
            class="flex items-center justify-center text-white bg-[#EA380C] rounded-md px-3 py-2 gap-2"
          >
        ...
        <div
          class="flex w-[288px] items-center p-4 gap-4 border border-[#82848E] rounded-lg place-content-between"
        >
          <p class="text-[22px] font-normal leading-7 w-auto mr-5">
            All projects
          </p>
      ...
      <div
        class="flex items-center justify-center content-center gap-x-[60px] gap-y-6 flex-wrap mt-[56px]"
      >
        <div class="flex flex-col w-[392px] items-start gap-4">
          <img
            class="h-[240px] w-full rounded-xl self-start"
            src="{{asset('upload/articles/card img.png')}}"
            alt=""
          />
          <button
