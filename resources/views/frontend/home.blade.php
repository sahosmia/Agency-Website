...
<div class="container ">
    <div class="text-center py-20">
        ...
        <h1 class="heading-text-regular-large text-secondary-950">We provide <span class=" text-primary-600 ">Digital
                Marketing</span></h1>
    ...
    {{-- hero card --}}
    <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4   justify-center   gap-6  w-full md:w-9/12 m-auto pt-15 pb-20">
    ...
    {{-- reviewer card --}}
    <div class=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 w-full md:w-9/12 m-auto pt-15 pb-20">
    ...
    <div class="w-full md:w-9/12 m-auto pt-15 pb-20">
        <h1 class="text-center heading-text-regular-medium text-secondary-900">Find the Perfect Service for Your Needs
        </h1>
        <div
            class="flex w-6/10 m-auto items-center mt-8 p-4 pl-0 gap-2 border border-secondary-400 rounded-lg place-content-between">
    ...
    <div class="w-full md:w-9/12 m-auto pt-15 pb-20">
        ...
        <p class="sub-title-medium-regular text-secondary-600 pt-8 text-center w-8/12 mx-auto">We understand that every
            business is unique, and finding the right digital solution can be challenging. That’s why we offer a FREE
            first-time consultation to help you get started!</p>

        <div class="mt-8 border border-secondary-400 rounded-2xl p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="title-text-bold-medium text-secondary-900">US Appointment</h2>
                <div class="flex items-center gap-4">
                    <button class="text-secondary-600 hover:text-primary-600">
            ...
            <div class="grid grid-cols-7 gap-4">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-4 space-y-2">
                        <button class="w-full py-2 border border-primary-600 text-primary-600 rounded-md">09:00
                            AM</button>
                        <button class="w-full py-2 border border-primary-600 text-primary-600 rounded-md">10:00
                            AM</button>
                        <button
                            class="w-full py-2 bg-secondary-200 text-secondary-500 rounded-md cursor-not-allowed">11:00
                            AM</button>
                        <p class="text-sm text-secondary-500">Booked</p>
                        <button class="w-full py-2 border border-primary-600 text-primary-600 rounded-md">01:00
                            PM</button>
                    </div>
                </div>
                <!-- Day 2 -->
                <div class="text-center">
                    ...
                    <div class="mt-4 space-y-2">
                        ...
                        <button class="w-full py-2 border border-primary-600 text-primary-600 rounded-md">10:00
                            AM</button>
                        <button class="w-full py-2 border border-primary-600 text-primary-600 rounded-md">11:00
                            AM</button>
                        <button class="w-full py-2 border border-primary-600 text-primary-600 rounded-md">01:00
                            PM</button>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <div class="mt-4 space-y-2">
                        <button class="w-full py-2 border border-primary-600 text-primary-600 rounded-md">09:00
                            AM</button>
                        <button
                            class="w-full py-2 bg-secondary-200 text-secondary-500 rounded-md cursor-not-allowed">10:00
                            AM</button>
                        <p class="text-sm text-secondary-500">Booked</p>
                        <button class="w-full py-2 border border-primary-600 text-primary-600 rounded-md">11:00
                            AM</button>
                ...
                <div class="text-center">
                    ...
                    <div class="mt-4 space-y-2">
                        <button
                            class="w-full py-2 bg-secondary-200 text-secondary-500 rounded-md cursor-not-allowed">Not
                            Available</button>
                    </div>
                </div>
                <!-- Day 7 -->
    ...
    <div class="slider-container w-full md:w-9/12 m-auto pt-15 pb-20 overflow-hidden">
        ...
        <div class="flex justify-center items-center mt-14">
            <a href="{{ route('front.projects.index') }}" class="button-label px-7 py-3   label-text-bold-large ">
                Explore More </a>
        </div>
    ...
    <div class="slider-container w-full md:w-9/12 m-auto pt-15 pb-20 overflow-hidden">
        ...
        <div class="flex justify-between my-8 ">
            ...
            <div class="button-group ">
                <button class="prev-btn-software button-label w-9 px-3 py-2  border-secondary-600 text-secondary-600">
                    <i class="w-5 h-5 fa-solid fa-circle-chevron-left"></i> </button>
                <button class="next-btn-software button-label w-9 px-3 py-2  border-secondary-600 text-secondary-600">
                    <i class="w-5 h-5 fa-solid fa-circle-chevron-right"></i> </button>
            </div>
        </div>
    ...
    <div class="flex justify-center items-center mt-14">
        <a href="{{ route('front.softwares.index') }}" class="button-label px-7 py-3   label-text-bold-large "> See
            details
        </a>
    </div>
    ...
    <div class="w-full md:w-9/12 m-auto pt-15 pb-20">
        <h1 class="heading-text-regular-medium text-center text-secondary-900">Working Process</h1>
    ...
    {{-- Contact us start --}}
    <div class="w-full md:w-9/12 m-auto pt-15 pb-20">
        <h1 class="heading-text-regular-medium text-center text-secondary-900 mb-8">Contact Us</h1>
    ...
    <div class="w-full md:w-9/12 m-auto pt-15 pb-20">
        <h1 class="heading-text-regular-medium text-center text-secondary-900">Companies who Trust Us</h1>
        <p class="sub-title-medium-regular text-center text-secondary-600 w-7/12 mx-auto mt-4">We are proud to serve
            businesses and organizations across multiple countries and industries. We helped clients worldwide achieve
    ...
    <div class="w-full md:w-9/12 m-auto pt-15 pb-20">
        <h1 class="heading-text-regular-medium text-center text-secondary-900">Clients Around the World</h1>
        <p class="sub-title-medium-regular text-center text-secondary-600 w-7/12 mx-auto mt-4">We are proud to serve
            businesses and organizations across multiple countries and industries. We helped clients worldwide achieve
            success in the digital landscape.</p>
    ...
    <div class="slider-container w-full md:w-10/12 m-auto pt-15 pb-20 overflow-hidden">
        <h1 class="heading-text-regular-medium text-center text-secondary-900">Client Reviews</h1>
        <div class="flex justify-between my-8 gap-5">
            <p class="body-text-regular-medium text-secondary-800 w-full md:w-1/2">Hear from our satisfied clients!
                Their
                feedback highlights our commitment to delivering exceptional digital solutions that drive results and
                build
                trust.</p>
            <div class="button-group">
                <button
                    class="prev-btn-client-reviews button-label w-9 px-3 py-2 border-secondary-600 text-secondary-600">
                    <i class="w-5 h-5 fa-solid fa-circle-chevron-left"></i> </button>
                <button
                    class="next-btn-client-reviews button-label w-9 px-3 py-2 border-secondary-600 text-secondary-600">
                    <i class="w-5 h-5 fa-solid fa-circle-chevron-right"></i> </button>
            </div>
        </div>
    ...
    {{-- FAQ start --}}
    <div class="w-full md:w-9/12 m-auto pt-15 pb-20" x-data="{ open: 0 }">
        <h1 class="heading-text-regular-medium text-center text-secondary-900">FAQ's</h1>
        <div class="mt-8 space-y-4">
            <div class="border border-secondary-400 rounded-lg">
                ...
                <div x-show="open === 1" class="p-4 border-t border-secondary-400">
                    <p class="body-text-regular-medium text-secondary-600">We offer a comprehensive range of digital
                        ...
                        marketing, SEO, and more. Our goal is to provide end-to-end solutions to help your business
                        thrive
            ...
            <div class="border border-secondary-400 rounded-lg">
                ...
                <div x-show="open === 2" class="p-4 border-t border-secondary-400">
                    <p class="body-text-regular-medium text-secondary-600">We have experience working with a diverse
                        range
                        of industries, including e-commerce, healthcare, education, and technology. Our team is
                        adaptable
            ...
            <div class="border border-secondary-400 rounded-lg">
                <div class="flex justify-between items-center p-4 cursor-pointer" @click="open = (open === 3 ? 0 : 3)">
                    <h2 class="title-text-bold-medium text-secondary-950">Do you provide support after project
                        completion?
                    </h2>
                    <i class="fa-solid" :class="open === 3 ? 'fa-minus' : 'fa-plus'"></i>
                </div>
                <div x-show="open === 3" class="p-4 border-t border-secondary-400">
                    <p class="body-text-regular-medium text-secondary-600">Yes, we offer ongoing support and maintenance
                        to
    ...
    <div class="slider-container w-full md:w-10/12 m-auto pt-15 pb-20 overflow-hidden">
        ...
        <div class="flex justify-between my-8 gap-5">
            <p class="body-text-regular-medium text-secondary-800 w-full md:w-1/2">Stay informed with our expert
                insights!
                Explore articles on the latest trends, tips, and strategies in web design, digital marketing, and more.
            </p>
            <div class="button-group">
