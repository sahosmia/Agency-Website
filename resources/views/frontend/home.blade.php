    ...
    <div class="container">
        ...
        <div class="my-20">
            <h1 class="text-center heading-text-regular-medium text-secondary-900">Find the Perfect Service for Your
                Needs</h1>
            <p class="text-center">Ei part ta korte hobe.</p>
        ...
        <div class="my-20">
            ...
            <h1 class="text-center heading-text-regular-medium text-secondary-900 mt-15 mb-8">Values we live by</h1>
                ...
                <div class="flex flex-col gap-4 w-4/12">
                    ...
                    <div class="">
                        ...
                        <div class="flex gap-1 justify-center items-center mt-2">
                            ...
                            <button class="w-4/12 button-label">See live preview <span> <i
                ...
                <div class="w-4/12 flex flex-col gap-7">
                    ...
                    <div>
                        ...
                        <div class="pt-2 flex flex-wrap gap-x-6 gap-y-4">
                            ...
                            <a class="flex justify-center items-center gap-2 rounded-sm border border-secondary-800 min-w-[184px] h-9 group"
                                href="#">
                    ...
                    <form action="">
                        <div class="flex  flex-col p-6 gap-6 border border-secondary-400 rounded-2xl m-auto  mb-20">
                            ...
                            <div class="flex gap-2 flex-col"><label class="inpul-label" for="">Your
                                    name</label><input type="text" name="" id=""
                                    placeholder="eg. Jhon brgke" value="">
                            </div>
                            <div class="flex gap-2 flex-col"><label class="inpul-label" for="">Your
                                    email</label><input type="email" name="" id=""
                                    placeholder="eg.jhonbrgke@gmail.com" value="">
                            </div>
        ...
        <div class="flex flex-col gap-8 justify-center items-center mt-15 mb-20">
            ...
            <div class="w-7/12 ">
                <p class="sub-title-medium-regular text-secondary-600  text-center text-wrap">we are proud to serve businesses and organizations across multiple countries and industries. We helped clients worldwide achieve success in the digital landscape.</p>
            </div>
