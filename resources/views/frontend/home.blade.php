    ...
    <div class="py-10 md:py-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-center gap-6 py-10 md:py-15">
            ...
            <div class="hero-card">
                ...
                <p class="body-text-regular-small text-secondary-800">{{ $homeSettings['hero_card_three_description'] ??
                    '' }}</p>
            </div>
        </div>
        {{-- hero card --}}
        ...
        <div class="w-full md:w-10/12 lg:w-9/12 m-auto pt-10 md:pt-15 pb-10 md:pb-20">
            <h2 class="heading-text-regular-large text-secondary-950 text-center text-2xl md:text-4xl">Let's Discuss
                Your
                Project!</h2>
            <p class="sub-title-medium-regular text-secondary-600 pt-8 text-center w-full md:w-10/12 lg:w-8/12 mx-auto">
                We
        ...
        <div class="slider-container mt-10 md:mt-15 mb-10 md:mb-20 overflow-hidden">
            <h2 class="text-center heading-text-regular-medium text-2xl md:text-3xl">{{ $homeSettings['projects_title']
                ?? '' }}</h2>
        ...
        {{-- our services --}}
        <div class="slider-container mt-10 md:mt-15 mb-10 md:mb-20 overflow-hidden">
            <h2 class="text-center heading-text-regular-medium text-2xl md:text-3xl">{{ $homeSettings['services_title']
                ?? '' }}</h2>
            <div class="flex flex-col md:flex-row justify-between my-8 gap-5">
                <p class="body-text-regular-medium text-secondary-800 w-full md:w-1/2">{{
                ...
                <div class="service-item">
                    <div class="flex flex-col gap-5 p-6 bg-white border rounded-md border-secondary-400">
                        ...
                        <div class="w-full flex justify-center mt-8">
                            <a href="{{ route('services.show', $service->slug) }}" class="button-label px-4 py-2">See
                                plan</a>
                        </div>
                    </div>
                </div>
        ...
        {{-- Software's Solution --}}
        <div class="slider-container mt-10 md:mt-15 mb-10 md:mb-20 overflow-hidden">
            <h2 class="text-center heading-text-regular-medium text-2xl md:text-3xl">{{ $homeSettings['software_title']
                ?? '' }}</h2>
            <div class="flex flex-col md:flex-row justify-between my-8 gap-5">
                <p class="body-text-regular-medium text-secondary-800 w-full md:w-1/2">{{
