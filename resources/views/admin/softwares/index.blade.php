...
@section('back-button')
{{-- Use x-admin.button instead of x-admin.create-button --}}
<x-admin.button :route="route('admin.softwares.create')" text="Create" />
@endsection
    ...
    <table class="w-full text-sm text-gray-700">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-5 py-3">{{ $software->category->title }}</td>
                <td class="px-5 py-3 text-center">
                    <x-admin.status-badge :is-active="$software->is_active" />
                </td>
                <td class="px-5 py-3 text-right">
                    <x-admin.actions-dropdown :showUrl="route('admin.softwares.show', $software)"
