        ...
        <form action="">
            <div class="flex w-6/12 flex-col p-6 gap-6 border border-secondary-400 rounded-2xl m-auto mt-8 mb-20">
                <div class="flex gap-2 flex-col">
                    <button class="button-label  px-6 py-3 label-text-bold-large "> <span class="mr-2"><i class="fa-brands fa-google"></i></span> Continue with Google</button>
                </div>
                <div class="flex gap-2 flex-col">
                    <button class="button-label  px-6 py-3 label-text-bold-large "> <span class="mr-2"><i class="fa-brands fa-apple"></i></span> Continue with Google</button>
                </div>
                ...
                <div class="flex gap-2 flex-col"><label class="inpul-label" for="">Your e-mail</label><input type="email" name="" id="" placeholder="Enter your e-mail" value="">
                </div>
                <div class="flex gap-2 flex-col"><label class="inpul-label" for="">Password</label><input type="text" name="" id="" placeholder="Enter your password" value="">
                    <span></span>
                </div>
                ...
                <p class="text-sm text-secondary-600">By signing in you agree to the Yeasin Arena <span class="text-[#230BFF]">Privacy
                ...
                <div class="flex gap-2 flex-col text-center">
                    <p class="label-text-regular-small text-secondary-600">Don't have an account? <span class="label-text-bold-small text-secondary-600">Purchase
