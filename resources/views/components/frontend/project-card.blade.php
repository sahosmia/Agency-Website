 <div class=" flex flex-col gap-4 ">
     ...
     <div>
         ...
         <div class="flex gap-2 justify-between items-center mt-2">
             ...
             <a href="{{ $project->live_preview_link }}" class="bg-white flex justify-center items-center gap-2 rounded py-2 px-3 text-nowrap  text-secondary-800 text-base/5 font-semibold">See live preview <span> <i
