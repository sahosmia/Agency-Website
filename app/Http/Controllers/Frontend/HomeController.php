...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $articles = Article::with('article_category:id,title')->latest()->limit($itemLimit)->get();
        $projects = Project::with('project_category:id,title')->orderBy('sort')->limit($itemLimit)->get();
        $softwares = Software::with('software_category:id,title')->latest()->limit($itemLimit)->get();
        $services = Service::with('service_category:id,title')->latest()->limit($itemLimit)->get();
